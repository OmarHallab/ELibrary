...
class Whatever
  ...
  def self.get_me_data(domain_path)
    response = HTTParty.get(domain_path)
...
@returnvariable = Whatever.get_me_data('http://isbndb.com/api/v2/json/5PYFR4XU/books?q=science')
